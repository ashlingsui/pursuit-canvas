ALTER TABLE public.applications ALTER COLUMN stage SET DEFAULT 'to_be_applied';
...
BEGIN
  ...
  FROM (VALUES
    ('Nimbus Forge', 'Product Manager, Build Platform', current_date - 4, 'Nimbus_Infra', 'to_be_applied', NULL, NULL, 'San Francisco, CA', 'Mid', 1),
    ('Rowan Data', 'Senior PM, Pipelines', current_date - 9, 'Rowan_Data', 'to_be_applied', NULL, NULL, 'Remote (US)', 'Senior', 2),
